 ...
 * @author andre
 */
public class GUICrearActividad extends javax.swing.JFrame {

    /**
     * Creates new form GUICrearActividad
     */
    ...
    public GUICrearActividad(HashGeneric<String, Persona> usuarios, HashGeneric<String, Persona> administradores, HashGeneric<Integer, Materia> materias, AdminDataBaseHandler adminbase, MateriasDataBaseHandler materiasbase, UsuariosDataBaseHandler userbase, Estudiante estudiante) {
        ...
        TituloText.setText("Nuevo título");
        ImpText.setText("1");
        descText.setText("Descripción");
        ...
        jComboBoxAño.setSelectedItem(String.valueOf(casilla.getTime().getYear() + 1900));
        ...
        jComboBoxMes.setSelectedIndex(casilla.getTime().getMonth());
        ...
        jComboBoxDia.setSelectedIndex(casilla.getTime().getDate() - 1);

        jComboBoxHora.setSelectedIndex(casilla.getTime().getHours());
//        jComboBoxMinuto2.setSelectedIndex(casilla.getTime().getMinutes());

        jComboBoxAño2.setModel((new DefaultComboBoxModel(
                new String[]{String.valueOf(casilla.getTime().getYear() - 2 + 1900), String.valueOf(casilla.getTime().getYear() - 1 + 1900), String.valueOf(casilla.getTime().getYear() + 1900), String.valueOf(casilla.getTime().getYear() + 1 + 1900), String.valueOf(casilla.getTime().getYear() + 2 + 1900)})));
        jComboBoxAño2.setSelectedItem(String.valueOf(casilla.getTime().getYear() + 1900));
        jComboBoxMes2.setModel((new DefaultComboBoxModel(
                new String[]{"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"})));

        jComboBoxMes2.setSelectedIndex(casilla.getTime().getMonth());
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Aquí puede crear una nueva actividad");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(205, 205, 205)
                                .addComponent(JBGuardarYVolver, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(30, 30, 30))))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUICrearActividad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUICrearActividad().setVisible(true);
            }
        });
    }
