...
//        
        ...
        jTTablaMaterias.addMouseListener(new MouseAdapter() {
            ...
            editar=true;    
                ...
                if (jTTablaMaterias.getModel().getColumnClass(columna).equals(JButton.class)&&columna==0) {
                    ...
                    usuarios.remove(String.valueOf(jTTablaMaterias.getValueAt(fila,4)));
    ...
    private void initComponents() {
        ...
        panelTituloLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelTituloLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(VolverAInicio, javax.swing.GroupLayout.DEFAULT_SIZE, 237, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(labelLogo, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
                .addGap(0, 0, 0)
    ...
    public HashGeneric<String,Materia> materiasEditadas(){
            ...
            for(int i=0;i<materiaEditada.getGrupos().length;i++){
                
                materiaEditada.getGrupos()[i]= new Grupo(Integer.parseInt(String.valueOf(jTTablaMaterias.getValueAt(i,2))), 
                        String.valueOf(jTTablaMaterias.getValueAt(i,1)), 
                        materiaEditada.getGrupos()[i].getHorario());
            }

            materias.get(materia.getCodigo()).setGrupos(materiaEditada.getGrupos());
